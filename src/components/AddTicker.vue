      ...
      <div class="max-w-xs">
        ...
        <div class="mt-1 relative rounded-md shadow-md">
          <input
            ...
            name="wallet"
            id="wallet"
            class="block w-full pl-2 pb-1 pr-10 mb-2 border-gray-300 text-gray-900 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm rounded-md"
  ...
  methods: {
    add(coin) {
      if (!this.coinsList.find((t) => t.Symbol == coin.toUpperCase())) {
        if (this.ticker === '')
          return (this.error = 'Введите название монетки');
